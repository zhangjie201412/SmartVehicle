...
#define RCC_APBxPeriph_GPS_USART_IO			RCC_APB2Periph_GPIOC
#define RCC_APBxPeriph_GPS_USART            RCC_APB1Periph_UART4
#define GPS_USART_TXD						GPIO_Pin_10
#define GPS_USART_RXD				        GPIO_Pin_11
#define GPS_USART_IO                        GPIOC
#define GPS_USART	                        UART4
#define GPS_PinRemap                        DISABLE
#define GPS_USARTAPB                        APB1
